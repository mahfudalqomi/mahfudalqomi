                            ...
                            <form action="proses_update_pembelian.php" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="text" name="pelanggan_id" class="form-control" hidden
                                            value="<?= $d['pelanggan_id']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nomor_telepon" autocomplete="off"
                                            class="form-control" value="<?= $d['nomor_telepon']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Alamat</label>
